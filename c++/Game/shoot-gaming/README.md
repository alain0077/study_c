...
# 得られた知見
オブジェクト指向論による実装をするにあたり，システムを個々のオブジェクトという捉え方をし，設計を考えました．設計は，[龍神録プログラミングの館](https://dixq.net/rp/index.html)を参考にしました．その設計に従い，シーンの切り替えやシューティングゲームのあたり判定などシステムの根幹を実装していきました．一からの実装は，かなり時間がかかる作業でした．しかし，その根幹の実装さえしてしまえば，後は，敵のパターンの拡張や弾の種類などの拡張で，ゲームが出来上がっていくのが面白く感じました．クラスごとに役割や担当がしっかりと別れているので，拡張や機能の追加をするときに変更する箇所がはっきりしていました．また，その範囲も限られていることが多く，オブジェクト指向による実装の利点と言われている拡張などのカスタマイズのしやすさを実感すること出来ました．
